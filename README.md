...
AI 결과는 명식의 특징과 강점·아쉬움·보완 방향을 담은 4~5문장 요약 뒤에 핵심 성향, 내면과 삶의 방향, 일과 커리어, 재물운, 연애 및 결혼운, 건강과 컨디션, 가족과 대인관계의 일곱 분야를 보여주고 ‘한 줄로 정리하면’으로 마친다. 이전 12단계·월별 AI 해석 출력은 사용하지 않는다. 시기 계산 자료는 상세 명반의 판독 요약에서 확인한다.
