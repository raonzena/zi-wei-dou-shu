    ...
    sections: readingSections.map((section, index) => {
      ...
      return {
        ...
        paragraphs: [
          {
            ...passage(
              `${palace.name}의 성향을 바탕으로 ${section.label}의 생활 모습을 설명하는 모의 문장입니다. 익숙한 선택의 기준을 먼저 살펴봅니다. 상황에 따라 다른 반응이 나올 수도 있습니다. 예를 들어 중요한 선택을 앞두고 기준을 글로 정리할 수 있습니다. 그러면 무엇을 우선하는지 더 분명하게 확인할 수 있습니다. 다만 같은 방법이 모든 상황에 맞는 것은 아닙니다. 실제 경험에 따라 나타나는 정도는 다를 수 있습니다.`,
              palace.id,
            ),
            id: 'p1' as 'p1' | 'p2' | 'p3',
          },
