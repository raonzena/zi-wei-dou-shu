    ...
    <main className={styles.main}>
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          입력한 생년월일, 출생 시각, 성별은 명반을 계산하는 데 사용하며 원본
          입력 값은 저장하지 않습니다. 계산된 명반과 풀이는 결과 링크로 다시 볼
          수 있도록 30일간 저장합니다. 결과 링크를 아는 사람은 해당 내용을
          열람할 수 있으므로 공개를 원하지 않는 곳에는 링크를 공유하지 마세요.
        </p>
      </section>
